...
| **R-1** | - все сервисы должны работать (отказоустойчивость) 24/7 в 99.9% случаев                                                      |Отказоустойчивость - доступность и отзывчивать при частичном отказе системы, например, если отвалится call-центр подрядчика, то клиенты не должны этого заметить|
|         |                                                                                                                              |                                |
