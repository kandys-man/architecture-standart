...
| :-: | :- | :- | :- |
|1|Менеджер бэк офиса, АБС, Система кол-центра             |Передача ставок в кол-центр|1. Менеджер бэк-офиса формирует новые ставки<br>        |
|||                                                                                    |2. Ставки отправляются в систему кол-центра             |
|2|Менеджер бэк офиса, АБС, Система партнерского кол-центра|Передача ставок в кол-центр|1. Менеджер бэк-офиса формирует новые ставки<br>        |
|||                                                                                    |2. Ставки отправляются в систему партнерского кол-центра|
|3|Менеджер кол-центра, Клиент, система кол-центра|Консультация по текущим ставкам в кол-центре|1. Клиент звонит в кол-центр, запрашивает текущие ставки по депозитам<br>|
|||                                                                                            |2. Менеджер кол-центра смотрит текущие установленные ставки в системе<br>|
|||                                                                                            |3. Менеджер передает клиенту информацию                                  |
|4|Менеджер кол-центра, Клиент, система партнерского кол-центра|Консультация по текущим ставкам в партнерском кол-центре|1. Клиент звонит в кол-центр, запрашивает текущие ставки по депозитам<br>|
|||                                                                                                                     |2. Менеджер кол-центра смотрит текущие установленные ставки в системе<br>|
|||                                                                                                                     |3. Менеджер передает клиенту информацию                                  |
